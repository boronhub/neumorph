let panel;
const {Shadow, Rectangle, Ellipse, Polygon, Text, Color, selection, Artboard } = require("scenegraph");
...
function create() {
  ...
  function createCircle() {
    ...
    editDocument({ editLabel: "Create a circle"}, function(selection){
        const blackShadowCircle = new Ellipse();
        blackShadowCircle.radiusX = radius;
        blackShadowCircle.radiusY = radius;
        blackShadowCircle.isCircle = true;
        blackShadowCircle.fill = newColor;
        blackShadowCircle.shadow = myShadow1;
        blackShadowCircle.cornerRadii = {topLeft:40, topRight:40, bottomRight:40, bottomLeft:40}
        ...
        const whiteShadowCircle = new Ellipse();
        whiteShadowCircle.radiusX = radius;
        whiteShadowCircle.radiusY = radius;
        whiteShadowCircle.isCircle = true;
        whiteShadowCircle.fill = newColor;
        whiteShadowCircle.shadow = myShadow2;
        whiteShadowCircle.cornerRadii = {topLeft:40, topRight:40, bottomRight:40, bottomLeft:40}
